...
@       IN      AAAA    ::1' > /etc/bind/jarkom/arjuna.a07.com
...
@       IN      AAAA    ::1' > /etc/bind/jarkom/abimanyu.a07.com
...
4                         IN      PTR     abimanyu.a07.com.' > /etc/bind/jarkom/1.172.192.in-addr.arpa
...
2                         IN      PTR     arjuna.a07.com.' > /etc/bind/jarkom/2.172.192.in-addr.arpa
